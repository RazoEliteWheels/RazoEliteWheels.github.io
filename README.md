...
<head>
  ...
  <title>Razo Elite Wheels | Rines y Llantas de Lujo</title>
  <link href="https://fonts.googleapis.com/css2?family=Montserrat:wght@400;600;800&display=swap" rel="stylesheet">
  <style>
    body {
      margin: 0;
      font-family: 'Montserrat', sans-serif;
      background: url('https://img.freepik.com/vector-premium/fondo-negro-brillante-realista_23-2150069277.jpg') center/cover no-repeat;
      color: #ffffff;
    }
    header {
    ...
    .btn-contacto, .btn-email, .btn-ubicacion {
      margin-top: 10px;
      padding: 10px 20px;
      border: none;
      border-radius: 5px;
